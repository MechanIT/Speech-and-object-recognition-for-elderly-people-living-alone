...
Yolo_net = cv2.dnn.readNet('C:\Open_Source\Term_Project_yolo\yolov3\yolov3_tiny.weights', 
                           'C:\Open_Source\Term_Project_yolo\yolov3\yolov3_tiny.cfg')
with open('C:\Open_Source\Term_Project_yolo\yolov3\yolo_name.txt', 'r', encoding='utf-8') as f:
